...
var Root = function (_React$Component) {
  ...
  _createClass(Root, [{
    ...
    value: function render() {
      return _react2.default.createElement(_scale2.default, { notes: this.state.notes });
    }
  }]);
...
var EMPTY_SCALE = exports.EMPTY_SCALE = function EMPTY_SCALE() {
...
var neighbors = exports.neighbors = function neighbors(notes) {
  var neighbors = [];
  var pegs = notesToPegs(notes);
  var temp = void 0;

  pegs.forEach(function (peg, num) {
...
var buildKeyWheel = exports.buildKeyWheel = function buildKeyWheel(start) {
  ...
  while (visited.length < 36) {
    ...
    neighbs.forEach(function (neighborKey) {
  ...
  visited.forEach(function (notes) {
    notesToPegs(notes);
  });
  return start;
};
