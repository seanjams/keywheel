...
export function chordCubeExperimentalConstants(edgeSize: number): {
    ...
    function generateVertexLayer(
        ...
        const getVertex = (
            ...
            if (chordName === ChordNames.dim7Chord) {
            ...
            if (chordName === ChordNames.domb5Chord) {
                alternativeKeys.push(
                    getKey(mod(rootIdx + 6, 12), chordName, layerIdx),
                );
            }
        ...
        return [
            {
                ...
                // ...
                // [getKey(augRoots[0], ChordNames.augChord)]: getVertex(
                //     augRoots[0],
                //     ChordNames.augChord,
                //     [2, 0, -2],
                // ),
                // [getKey(augRoots[1], ChordNames.augChord)]: getVertex(
                //     augRoots[1],
                //     ChordNames.augChord,
                //     [2, 4, 4],
                // ),
                // [getKey(augRoots[2], ChordNames.augChord)]: getVertex(
                //     augRoots[2],
                //     ChordNames.augChord,
                //     [0, 0, 2],
                // ),
                // [getKey(augRoots[3], ChordNames.augChord)]: getVertex(
                //     augRoots[3],
                //     ChordNames.augChord,
                //     [2, 4, 0],
                // ),
